    ...
    var e = f.dom,
        ...
        g, b = function () {
            ...
            initObserver: function () {
                ...
                this.observer = {
                    onMousedown: function () {
                        f.browser.ie || (e.setStyle(a._dragProxy.proxyEl, "left", a.getX() + a._outBorder + "px"), e.setStyle(a._dragProxy.proxyEl, "top", a.getY() + a._outBorder + "px"), e.setStyle(a._dragProxy.proxyEl, "width", a._width - a._outBorder * 2 + "px"), e.setStyle(a._dragProxy.proxyEl, "height", a._height - a._outBorder * 2 + "px"), e.setStyle(a._dragProxy.maskEl,
                            "zIndex", 60002), e.show(a._dragProxy.maskEl))
                    },
                    onMove: function (b) {
                        a._x = b.x;
                        a._y = b.y;
            ...
            setTitle: function (a) {
                ...
                this.option.titleIcon && (a = '<span class="window_title_icon" style="background:url(' +
                    this.option.titleIcon + ') no-repeat center center;">&nbsp;&nbsp;&nbsp;&nbsp;</span>' + a);
            ...
            setCurrentWithoutFocus: function (a) {
                a && a.fromInit && this.windowType === "widget" ? (this.show(), this.setNotCurrent()) : (this.getWindowFlags() & c.CONST.WINDOW_FLAG_CURRENT || (this.setStyleCurrent(), this.show(), this.setWindowFlags(this.getWindowFlags() | c.CONST.WINDOW_FLAG_CURRENT)), d.notifyObservers(this,
                    "setCurrent"))
            },
            ...
            max: function () {
                if (!(this.getWindowFlags() &
                    c.CONST.WINDOW_FLAG_FULLSCREEN)) this._restoreX = this._x, this._restoreY = this._y;
            ...
            fullscreen: function () {
                ...
                this.setWindowFlags(this.getWindowFlags() |
                    c.CONST.WINDOW_FLAG_FULLSCREEN);
            ...
            restore: function () {
                this.setWindowFlags(this.getWindowFlags() & ~c.CONST.WINDOW_FLAG_MAX |
                    c.CONST.WINDOW_FLAG_NORMAL);
            ...
            setWinWidth: function (a) {
                ...
                e.setStyle(this._bodyOuter,
                    "width", this._bodyWidth + this.subWinWidth + this.subWinMarginLeft + "px");
            ...
            setBodyWidth: function (a) {
                ...
                this._bodyWidth = a;
                this._width =
                    b = b + this.subWinWidth + this.subWinMarginLeft;
            ...
            enableDrag: function () {
                ...
                this.getBoxStatus() !== "max" && this.getBoxStatus() !==
                    "fullscreen" && this.setEnableDrag()
            },
                ...
                if (this.option.dragable) {
                    if (this._dragController) {
                        ...
                        this.container, {
                            ...
                            isOverRight: !0,
                            isLockCursorInScreen: !0
                        }), d.addObserver(this._dragController, "move", this.observer.onMove)), d.addObserver(this._dragController, "beforeStart", this.observer.onBeforeDragStart), d.addObserver(this._dragController, "start", this.observer.onDragStart), d.addObserver(this._dragController,
                        "end", this.observer.onDragEnd);
            ...
            setEnableResize: function () {
                if (this.option.resize) this._resizeController ? (this.option.dragProxy && d.addObserver(this._resizeController, "mousedown", this.observer.onMousedown), this._resizeController.show()) : (this.option.dragProxy ? (this._dragProxy = b(), this._resizeController = new f.ui.Resize(this._window_inner, this._dragProxy.proxyEl, {
                    ...
                    "resize", this.observer.onResize)), d.addObserver(this._resizeController, "mousedown", this.observer.onDragStart), d.addObserver(this._resizeController, "end", this.observer.onDragEnd))
            },
            ...
            setSubWinInner: function (a) {
                ...
                this.getBoxStatus() != "fullscreen" &&
                    this.getBoxStatus() != "max" ? (this.setBodyWidth(a.width || this._bodyWidth), this.setBodyHeight(a.height || this._bodyHeight)) : (this.setWinWidth(), this.setWinHeight());
                ...
                e.setStyle(this._subBodyOuter, "right",
                    "5px");
            ...
            hideSubWinInner: function () {
                ...
                a = this._restoreX;
                b = this._restoreY;
                this.getBoxStatus() == "fullscreen" ? (this.fullscreen(), this._restoreX = a, this._restoreY = b, this._restoreWidth = this.option.width, this._restoreHeight = this.option.height) : this.getBoxStatus() ==
                    "max" ? (this.max(), this._restoreX = a, this._restoreY = b, this._restoreWidth = this.option.width, this._restoreHeight = this.option.height) : (this.setWidth(this.option.width), this.setHeight(this.option.height));
                this.setMinLimite({
                    minWidth: this._minWidth,
                    minHeight: this._minHeight
                })
            ...
            setSubWinFollow: function () {
                ...
                var c = this,
                    f = function () {
                        c.setSubWinNone();
                        d.removeObserver(this.subWin._dragController,
                            "move", f)
                    };
        ...
        b = new f.Class({
            ...
            insertHtml: function (a) {
                if (a !== "") {
                    var c = this.getRange();
                    if (c)
                        if (c.pasteHTML) c.pasteHTML(a), c.collapse(!1), c.select();
                    ...
                    } else if (this.isEmpty() ? this._divArea.innerHTML = a : this._divArea.innerHTML += a, c = b.getRange()) a = this._divArea.lastChild,
            ...
            clearNodes: function () {
                for (var a = this._divArea, c, d, f = a.childNodes, e = f.length - 1, g; e >= 0; e--)
                    if (g = f[e], g.nodeType !== 3)
                        if (g.nodeType === 1) {
...
Jx().$package("alloy.businessClass", function (f) {
    var e = f.dom,
        ...
        g = new f.Class({
            ...
            getTemplate: function () {
                var b = this.getId(),
                    b = '\t\t\t\t<div id="window_outer_' + b + '" class="window_outer">\t\t\t\t\t<div id="window_inner_' +
                        b + '" class="window_inner" >\t\t\t\t\t\t<div class="window_bg_container" id="window_bg_container_' + b + '"></div>\t\t\t\t\t\t<div class="window_content">\t\t\t\t\t\t\t<div id="window_titleBar_' + b + '" class="window_titleBar">                                <div id="window_toolButtonBar_' + b + '" class="window_toolButtonBar"></div>\t\t\t\t\t\t\t\t<div id="window_titleButtonBar_' + b + '" class="window_titleButtonBar"></div>\t\t\t\t\t\t\t\t<div id="window_title_' + b + '" class="window_title titleText">App</div>\t\t\t\t\t\t\t</div>                            <div id="window_body_outer_' +
                        b + '" class="window_bodyOuter">                                 <div id="window_toolBar_' + b + '" class="window_toolBar"></div>                \t\t\t\t <div id="window_toggleToolbar_' + b + '" class ="app_toolbar_icon app_toolbar_toggle app_toolbar_toggle_up" style="display:none"></div>\t\t\t\t\t\t\t     <div id="window_body_' + b + '" class="window_bodyArea"></div>                            </div>\t\t\t\t\t\t\t<div id="window_controlArea_' + b + '" class="window_controlArea">\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>\t\t\t\t\t</div>\t\t\t\t</div>\t\t\t';
            ...
            initObserver: function () {
                ...
                f.extend(this.observer, {
                    ...
                    onTitleBarDblClick: function (c) {
                        b.option.doubleClickModeSwitch && (c.preventDefault(), d.notifyObservers(b, "dblClickTitleBar"), b.option.modeSwitch &&
                            (b.getBoxStatus() === "max" ? b.restore() : b.getBoxStatus() === "restore" && b.max()))
                    },
                    setCurrent: function () {
                        b.setCurrent()
                    },
            ...
            initDomReference: function () {
                var b = this.getId();
                this._titleBar = e.id("window_titleBar_" +
                    b);
                ...
                this._bg_container = this._window_bg = e.id("window_bg_container_" +
                    b)
            },
            initButtons: function () {
                var b = f.ui.Button,
    ...
    this.EqqWindow = new f.Class({
        ...
        getTemplate: function () {
            var b = this.getId(),
                b = '\t\t\t\t<div id="window_outer_' + b + '" class="window_outer eqq_window">\t\t\t\t\t<div id="window_inner_' +
                    b + '" class="window_inner" >\t\t\t\t\t\t<div class="window_bg_container" id="window_bg_container_' + b + '">\t\t\t\t\t\t</div>\t\t\t\t\t\t<div class="window_content">\t\t\t\t\t\t\t<div id="window_titleBar_' + b + '" class="window_titleBar">\t\t\t\t\t\t\t\t<div id="window_titleButtonBar_' + b + '" class="window_titleButtonBar"></div>\t\t\t\t\t\t\t\t<div id="window_title_' + b + '" class="window_title titleText">App</div>\t\t\t\t\t\t\t</div>                            <div id="window_body_outer_' + b + '" class="window_bodyOuter">                                 <div id="window_toolBar_' +
                    b + '" class="window_toolBar"></div>                \t\t\t\t <div id="window_toggleToolbar_' + b + '" class ="app_toolbar_icon app_toolbar_toggle app_toolbar_toggle_up" style="display:none"></div>\t\t\t\t\t\t\t     <div id="window_body_' + b + '" class="window_bodyArea"></div>                            </div>\t\t\t\t\t\t\t<div id="window_controlArea_' + b + '" class="window_controlArea">\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>\t\t\t\t\t</div>\t\t\t\t</div>\t\t\t';
            f.browser.ie && (b += '<iframe width="100%" height="100%" class="fullscreen_bg_iframe"></iframe>');
            return b
        }
    })
            ...
            getTemplate: function () {
                var b = this.getId(),
                    b = '\t\t\t\t<div id="widget_outer_' + b + '" class="widget_outer">\t\t\t\t\t<div id="widget_inner_' + b + '" class="widget_inner"  style="z-index:' + this.option.zIndex + '">\t\t\t\t\t\t<div id="widget_bg_container_' + b + '" class="widget_bg_container">\t\t\t\t\t\t\t<div class="widget_bg widget_center"></div>\t\t\t\t\t\t\t<div class="widget_bg widget_t"></div>\t\t\t\t\t\t\t<div class="widget_bg widget_rt"></div>\t\t\t\t\t\t\t<div class="widget_bg widget_r"></div>\t\t\t\t\t\t\t<div class="widget_bg widget_rb"></div>\t\t\t\t\t\t\t<div class="widget_bg widget_b"></div>\t\t\t\t\t\t\t<div class="widget_bg widget_lb"></div>\t\t\t\t\t\t\t<div class="widget_bg widget_l"></div>\t\t\t\t\t\t\t<div class="widget_bg widget_lt"></div>\t\t\t\t\t\t</div>\t\t\t\t\t\t<div class="widget_content">\t\t\t\t\t\t\t<div id="widget_titleBar_' +
                        b + '" class="widget_titleBar">\t\t\t\t\t\t\t\t<div id="widget_titleButtonBar_' + b + '" class="widget_titleButtonBar"></div>\t\t\t\t\t\t\t\t<div id="widget_title_' + b + '" class="widget_title"></div>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div id="widget_toolBar_' + b + '" class="widget_toolBar"></div>\t\t\t\t\t\t\t<div id="widget_Body_' + b + '" class="widget_bodyArea"></div>\t\t\t\t\t\t</div>\t\t\t\t\t</div>\t\t\t\t</div>\t\t\t';
            ...
            initObserver: function () {
                ...
                f.extend(this.observer, {
                    ...
                    onMouseupWidget: function (c) {
                        Math.abs(b._offX - c.clientX) + Math.abs(b._offY - c.clientY) < 10 && d.notifyObservers(b,
                            "shortMoveClick", b)
                    },
                    onPinDownButtonClick: function (c) {
                        c.preventDefault();
...
Jx().$package("alloy.Class", function (f) {
    var e = f.dom,
        ...
        c = {
            ...
            onIconContextMenu: function (a) {
                a.preventDefault();
                a.stopPropagation();
                this.isContextMenuEnable() && this.isEnable() && alloy.desktopManager.getDesktopStatus() != alloy.desktopManager.DESK_STATUS.EDIT && this.option.contextMenu && this.option.contextMenu.length &&
                    (a = alloy.layout.showContextMenu({
                    x: a.clientX,
                    y: a.clientY
                }, {
                    argument: this,
            ...
            onIconClick: function (a, b) {
                if (this.isEnable()) {
                    ...
                    this.option.longTouchable ? e.hasClass(a.target, "appButton_delete") || (b >= 1E3 ? alloy.desktopManager.getDesktopStatus() !== alloy.desktopManager.DESK_STATUS.EDIT &&
                        (alloy.desktopManager.setDesktopStatus(alloy.desktopManager.DESK_STATUS.EDIT), alloy.util.report2qqweb("screen|ipad|edit")) : alloy.desktopManager.getDesktopStatus() !== alloy.desktopManager.DESK_STATUS.EDIT && this.option.onClick && (this.option.onClick.call(this, a), d.notifyObservers(this, "iconclick"))) : !(b >= 1E3) && this.option.onClick && (this.option.onClick.call(this, a), d.notifyObservers(this, "iconclick"))
                }
            },
            onIconDbClick: function (a) {
                this.isEnable() && alloy.desktopManager.getDesktopStatus() !== alloy.desktopManager.DESK_STATUS.EDIT &&
                    this.option.onDbClick && this.option.onDbClick.call(this, a)
            },
    ...
    this.Icon = new f.Class({
        ...
        _formatTitle: function (a) {
            if (f.isArray(a)) {
                for (var b =
                    0; b < a.length; b++) a[b] = g.encodeHtmlAttributeSimple(a[b]);
        ...
        _createDom: function () {
            ...
            var j = this._domId = "alloy_icon_" + a.id + "_" + b++,
                ...
                m = a.icon,
                h = '<div class="appButton_appIcon ' + (m.className || "") + '" id="' + j + '_icon_div" style="' + (m.style || "") + '"><img id="' + j + '_img" class="appButton_appIconImg" src="' +
                    (m.url ? m.url : alloy.CONST.CDN_URL + "style/images/transparent.gif") + '" alt="' + h + '"/></div>                    <div class="appButton_appName" ><div id="' + j + '_name" class="appButton_appName_inner">' + g.encodeHtmlSimple(a.text) + '</div><div class="appButton_appName_inner_right"></div></div>                    <div class="appButton_delete" id="' + j + '_delete" title="\u5378\u8f7d\u5e94\u7528"></div>                ';
            k.innerHTML = h;
            a.parentNode.appendChild(k);
            this._iconEl = e.id(j + "_icon_div");
            this._iconImgEl = e.id(j +
                "_img");
...
Jx().$package("alloy.Class", function (f) {
    var e = f.dom,
        ...
        a = function (b, c, f) {
            ...
            a.src = alloy.CONST.CDN_URL +
                "style/images/transparent.gif";
                ...
                if ((n.id == "appMarket" || n.id == "diskExplorer" || n.id == "messageCenter") && f.browser.ie == 6) j(this._iconImgEl, this.option.icon.url);
                    ...
                    if (q) {
                        ...
                        var s = "",
                            t = f.browser.ie == 6,
                            s = q.type || q;
                        (s & 100) > 0 ? (s = r > 99999 ? p + q.bigIcon : v + "big.png", t ? a(o, s) : o.src = s) : (s & 10) > 0 ? (s = r > 99999 ? p + q.midIcon : v + "mid.png", t ? a(o, s) : o.src = s) : (s & 1) > 0 ? (s = r > 99999 ? p + q.smallIcon : v + "small.png", e.addClass(l, "appButton_appIcon_warp"), e.addClass(o, "appButton_smallIcon"), t ? a(o, s) : o.src =
                                s) : t ? a(o, alloy.CONST.CDN_URL + "style/images/big.png") : o.src = alloy.CONST.CDN_URL + "style/images/big.png"
                    }
                }
    ...
    var e = f.dom,
        ...
        h = {
            ...
            refreshIcon: function () {
                this._iconImgEl.src =
                    this.type == b.BUDDY ? alloy.util.getUserAvatar(this.fileId) : alloy.util.getGroupAvatar(this.fileId)
            },
            _createDom: function () {
...
Jx().$package("alloy.Class", function (f) {
    var e = f.dom,
        ...
        a = function (a, b) {
            a.src =
                alloy.CONST.CDN_URL + "style/images/transparent.gif";
            a.style.background = "none";
            a.style.filter = "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + b + "', sizingMethod='scale')"
        }, j = function (a) {
            a.stopPropagation()
            ...
            update: function () {
                ...
                b.items = b.items || [];
                b = b.items.length == 0 ? alloy.CONST.CDN_URL + "style/images/filesys/" + this.option.category + ".png?t=20111011001" : alloy.CONST.CDN_URL + "style/images/filesys/" + this.option.category +
                    "_o.png?t=20111011001";
            ...
            startEdit: function () {
                ...
                if (b.getAttribute("edit") != "true") {
                    ...
                    b.innerHTML = '<input maxlength="48" class="edit_input" id="explorer_edit_input_' +
                        a + '" type="text" style="width:100%" value="' + b.innerHTML + '" />';
    ...
    var e = f.dom,
        ...
        m = function (a) {
            ...
            onGetFileDownLoadSuccess: function (a) {
                a.retcode ==
                    0 && a.result && a.result.code == 0 ? alloy.storage.receiveFile(a.result.objs[0]) : alloy.layout.confirm("\u6587\u4ef6\u635f\u574f\u6216\u5df2\u88ab\u5220\u9664\uff0c\u662f\u5426\u5c06\u5176\u5728Q+ Web\u4e2d\u5220\u9664\uff1f", function () {
            ...
            init: function (a, b) {
                ...
                if (e.file.upload && (e.showUploadBar(), e.file.s == c.KINGSOFT)) e.onFileUploadComplete = function (a) {
                    ...
                    d.removeObserver(alloy.flashUploadManager,
                        "FileUploadComplete", e.onFileUploadComplete)
                })
            },
            ...
            uploadSuccess: function () {
                this.hideUploadBar();
                this.setTitle(["\u540d\u79f0\uff1a" + this.file.n, "\u5927\u5c0f\uff1a" + alloy.util.formatFileSize(this.file.size),
                    "\u4f4d\u7f6e\uff1a" + alloy.storage.getDiskById(this.file.s).name
                ]);
                this.disHalfOpacity();
            ...
            startEdit: function () {
                ...
                if (b.getAttribute("edit") != "true") {
                    ...
                    var l = this;
                    d.on(c, "keydown", function (a) {
                        a.keyCode == 13 ? (d.off(c, "keydown"), l.endEdit()) : g.byteLength(c.value) > 48 && a.keyCode != 8 &&
                            a.preventDefault()
                    })
                }
            },
            ...
            setText: function (a) {
                ...
                this.setTitle(["\u540d\u79f0\uff1a" + this.option.title, "\u5927\u5c0f" + alloy.util.formatFileSize(this.file.size),
                    "\u4f4d\u7f6e" + alloy.storage.getDiskById(this.file.s).name
                ])
            }
        })
...
Jx().$package("alloy.iconFactory", function (f) {
    var e = this,
        ...
        j = {
            ...
            onFileProcessed: function (a) {
                if (a =
                    e.getIcons(a.id, a.t))
                    for (var b = 0, c = a.length; b < c; b++) a[b].enable()
            },
            onUpdateNotifyNumber: function (a) {
                var b = e.getIcons(a.id, a.t);
                if (b)
                    for (var a = a.notifyNumber || 0, c = 0, d = b.length; c < d; c++)(b[c].notifyNumber = a) ? b[c].showNotify(a) : b[c].hideNotify()
            },
    ...
    this.init = function () {
        ...
        d.addObserver(alloy.fileSystem,
            "FileBeforeProcess", j.onFileBeforeProcess);
...
Jx().$package("alloy.navbar", function (f) {
    ...
    this.init = function () {
        ...
        for (var e = alloy.desktopManager.getDesktopList().length, r, l = alloy.desktopManager.getDragController(), g = 0; g <
            e; ++g) {
            r = j;
            var m = g,
...
Jx().$package("alloy.searchbar", function (f) {
    var e = this,
        ...
        n = function (a, b) {
            ...
            a == -1 ? alloy.util.report2qqweb("search|searchsoso|listsearch") : a == -2 ? alloy.util.report2qqweb("search|searchapp|clickseaapp") :
                alloy.util.report2qqweb("search|searchapp|clickrecapp")
        }, r = {
    ...
    var q = {
        ...
        fillResult: function (a) {
            ...
            for (l in a) {
                ...
                e.push('<li class="sb_resultList" idx="' + q.id + '"><a href="#" title="' +
                    j + '"><div class="listInner">' + j + "</div></a></li>")
            }
    ...
    var e = f.dom,
        ...
        c = {
            ...
            init: function (b) {
                ...
                b.windowType || e.setStyle(this.Window.body,
        ...
        h = new f.Class({
            ...
            decorateOkButton: function (a) {
                for (var b in a) a.hasOwnProperty(b) &&
                    e.setStyle(this.Window._okButton._node, b, a[b])
            }
        });
    this.MessageBox = j;
...
Jet().$package("alloy.businessClass", function (f) {
    ...
    this.ShareFriends = new f.Class({
        init: function (a) {
            ...
            var l = '\t\t\t\t<div class="sharef_t">\t\t\t\t\t<div class="sharef_popup_title">' + (a.title ? "\u5206\u4eab\u7ed9\u597d\u53cb - " + a.title : "\u5206\u4eab\u7ed9\u597d\u53cb") + '</div>\t\t\t\t\t<a href ="###" class ="sharef_close" id="share_close_' + h + '"></a>\t\t\t\t</div>\t\t\t\t<div class="sharef_m">\t\t\t\t\t<div class="sharef_popup_content_share sharef_popup_radius" id="sharef_popup_content_' + h + '">\t\t\t\t\t\t<div class="sharef_group_list sharef_multi_list" id="multi_list_' +
                h + '">\t\t\t\t\t\t\t<div>\t\t\t\t\t\t\t\t<h5 onclick="toggleItemList(this);"><span class="sharef_down_icon"></span>\u6211\u7684\u597d\u53cb</h5>\t\t\t\t\t\t\t\t<ul class="sharef_item_list">\t\t\t\t\t\t\t\t\t<li><div class="sharef_item_icon sharef_friend_icon"></div><span class="nick">\u6b63\u5728\u52a0\u8f7d\u4e2d\u2026\u2026</span><span class="sharef_selected_icon"></span></li>\t\t\t\t\t\t\t\t</ul>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>\t\t\t\t\t\t<div class="sharef_info_container">\t\t\t\t\t\t\t<h5 id="share_title_' +
                ...
                h + '"></span>\t\t\t\t\t\t\t<input class="sharef_submit sharef_disabled" id="share_submit_' + h + '" type="button" value="" />\t\t\t\t\t\t</div>\t\t\t\t\t</div>\t\t\t\t</div>\t\t\t\t<div class="sharef_b"></div>\t\t\t';
            ...
            var o = this,
                r = this.observer = {
                    ...
                    onClearSelection: function () {
                        ...
                        o._share_list_container.className =
                            "sharef_list_container sharef_tip";
            ...
            this._el = m;
            this._share_input =
                e.mini(".sharef_info_quote_content", this._share_info)[0];
        ...
        deleteItem: function (a, b) {
            for (var c = 0; c < this.share_list.length; ++c)
                if (this.share_list[c].uin == a && this.share_list[c].type == b) {
        ...
        addItem: function (a, b, c) {
            for (var d = 0; d < this.share_list.length; ++d)
                if (this.share_list[d].uin ==
                    a && this.share_list[d].type == b) return;
...
Jx().$package("alloy.businessClass", function (f) {
    ...
    this.App = new f.Class({
        init: function (b) {
            ...
            if ((b = parseInt(b.id)) &&
                b > 1E5) this.option.hasToolBar = !1;
        ...
        run: function (c) {
            ...
            if (f.platform.iPad) {
                var j = [],
                    ...
                    h;
                for (h in j)
                    if (j[h].toString() == this.option.id.toString()) {
                        k = !0;
                        break
                    }
                if (this.option.ipadIncompatible) {
                    k || alloy.layout.alert("\u5f88\u62b1\u6b49\uff0c" +
                        (this.option.title || "\u6b64") + "\u5e94\u7528\u6682\u4e0d\u652f\u6301iPad\u3002", null, {
                            modal: !0
                        });
                    return
                }
            ...
            if (window.webTop && this.option.id == 12) alloy.layout.alert("\u5f88\u62b1\u6b49\uff0c\u6b64\u5e94\u7528\u6682\u4e0d\u652f\u6301\u5ba2\u6237\u7aef\u3002", null, {
            ...
            else if (this.option.id == "56" && !f.sound.isReady) f.browser.plugins.flash < 9 ? alloy.layout.alert("\u5f88\u62b1\u6b49\uff0c\u53ef\u80fd\u7531\u4e8eFlash\u7248\u672c\u8fc7\u4f4e\uff0c\u97f3\u4e50\u76d2\u5b50\u65e0\u6cd5\u4f7f\u7528\uff0c<br />\u5efa\u8bae\u60a8\u5b89\u88c5\u6700\u65b0\u7248Flash\u540e\u4f7f\u7528\u3002") : g.addObserver(f.sound,
                "ready", function () {
                ...
                if (this.isRunning()) {
                    this.runOption = c;
                    if ((j = this.getAppUrl()) && this._iframe && this.option.id == "appMarket") this._iframe.src =
                        j;
                    ...
                    this.runOption = c;
                    this._isRunning = !0;
                    this.option.windowMode !== "none" && (k = f.clone(this.option), k = f.extend(k, c), this.createWindow(k), this.window && (f.isUndefined(k.x) && f.isNumber(this.option.right) && (h = this.window.getWidth(), this.window.setX(alloy.layout.getAvailableWidth() - h - this.option.right)), f.isUndefined(k.y) && f.isNumber(this.option.bottom) &&
                        (k = this.window.getHeight(), this.window.setY(alloy.layout.getAvailableHeight() - k - this.option.bottom)), this.window.windowType == "widget" && g.addObserver(this.window, "dragEnd", b)));
                    if (this.option.appType !== 1 && this.option.appType === 2) {
                        ...
                        if ((!this.option.ieOnly || f.browser.ie) && (!f.browser.ie || this.option.id != "13" || this.detectActiveX())) {
                            ...
                            k = '\t\t\t\t\t\t\t<div id="container_iframeApp_' + this.window.getId() + '" class="content_area">\t\t\t\t\t\t\t\t<div id="starting_iframeApp_' + this.window.getId() + '" class="appStartingCover">\t\t\t\t\t\t\t\t\t<div id="error_background_' + this.window.getId() + '" class="appStartingError">\t\t\t\t\t\t\t\t\t\t<a id="appRestart_' + this.window.getId() + '" class="appRestart" href="#"></a>\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t<div id="appText_' +
                                this.window.getId() + '" class="appText">\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t<div class="appStartingAnimation"></div>\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t<iframe id="iframeApp_' + this.window.getId() + '" name="' + j + '" class="iframeApp" frameborder="no"  allowtransparency="true" scrolling="auto" hidefocus></iframe>\t\t\t\t\t\t\t\t<div id="iframeApp_dragResizeMask_' + this.window.getId() + '" class="iframeDragResizeMask"></div>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t';
                            this.option.windowType != "widget" && f.platform.iPad &&
                                f.platform.iPad.split(".")[0] >= 4 && (k = '\t\t\t\t\t\t\t\t<div id="container_iframeApp_' + this.window.getId() + '" class="content_area">\t\t\t\t\t\t\t\t\t<div id="starting_iframeApp_' + this.window.getId() + '" class="appStartingCover">\t\t\t\t\t\t\t\t\t\t<div id="error_background_' + this.window.getId() + '" class="appStartingError">\t\t\t\t\t\t\t\t\t\t\t<a id="appRestart_' + this.window.getId() + '" class="appRestart" href="#"></a>\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t<div id="appText_' + this.window.getId() +
                                    '" class="appText">\t\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t\t<div class="appStartingAnimation"></div>\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t<div style="width:100%;position:absolute;height:100000px;">\t\t\t\t\t\t\t\t\t<iframe id="iframeApp_' + this.window.getId() + '" name="' + j + '" class="iframeApp" frameborder="no" allowtransparency="true" scrolling="auto" hidefocus ></iframe>\t\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t\t\t<iframe id="iframeApp_' + this.window.getId() + '_proxy" class="iframeApp" name="HiframeApp_' +
                                    this.window.getId() + '" src="' + qqweb.CONST.MAIN_URL + './touchpad.html?201110216001" frameborder="no" allowtransparency="true" scrolling="auto" hidefocus ></iframe>\t\t\t\t\t\t\t\t\t<div id="iframeApp_dragResizeMask_' + this.window.getId() + '" class="iframeDragResizeMask"></div>\t\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t');
                            ...
                            this._restart =
                                d.id("appRestart_" + this.window.getId());
                            ...
                            this.option.flashMode &&
                                g.addObserver(this.window, "min", o.onWindowMin);
        ...
        createWindow: function (b) {
            ...
            g.addObserver(d,
                "setNotCurrent", h.onWindowSetNotCurrent);
        ...
        exit: function () {
            ...
            else g.removeObserver(this,
                "runAgain"), g.notifyObservers(this, "exit"), this.destroy(), g.removeObserver(this, "exit")
        },
        destroy: function () {
        ...
        getAppUrl: function () {
            ...
            b && b.param && (a += b.param);
            return alloy.appconfig.makeUrl(a)
        },
        redirectToHome: function () {
            if (this.isRunning()) {
                d.setStyle(this._error,
                    "display", "none");
...
Jx().$package("alloy.component", function (f) {
    ...
    this.inviteInstallAppByC2C = function (a) {
        ...
        a.text = "\u6211\u6b63\u5728\u4f7f\u7528Q+ Web\u4e2d\u7684" +
            b.appName + "\u5e94\u7528\uff0c\u5f88\u4e0d\u9519\u54e6\uff0c\u9080\u8bf7\u4f60\u4e5f\u6765\u73a9\u3002" + alloy.CONST.MAIN_URL + "?run=" + encodeURIComponent('{"' + a._appId + '":{"defaultMode":"max"}}');
        c(a)
    };
    ...
    this.shareApp = function (a) {
        var b, e, g, a = a || {};
        if (b = a._appId)
            if (e = alloy.appconfig.getAllConfig(b)) alloy.appconfig.isQplusApp(b) ? (g = {
                cmd: 2,
                type: a.type || 2,
                text: a.msg || "\u5206\u4eab\u5e94\u7528",
                gaid: e.gaid,
                ...
                cmd: 0,
                text: (a.msg ||
                    "\u5206\u4eab\u5e94\u7528") + (a.title ? e.appName + " - " + a.title : e.appName),
                url: g,
                onAccept: function () {
                    a.onAccept && a.onAccept();
                    var c = alloy.portal.getApp(b);
...
Jx().$package("alloy.businessClass", function (f) {
    var e = this,
        ...
        k = function () {
            ...
            hidePanel: function (a) {
                if (a = this.get(a))
                    if (a.hide(), this._alterMode && this._window.setCurrent(), this._currentPanel == a) this._currentPanel = null
            },
    ...
    this.AppToolBar = new f.Class({
        init: function (a) {
            ...
            var f = this._shareUrl = alloy.CONST.MAIN_URL + "?run=" + encodeURIComponent('{"' + this._appId + '":{"defaultMode":"max"}}'),
                ...
                j = this._shareUrlEncode = alloy.CONST.MAIN_URL +
                    "?run=" + encodeURIComponent(encodeURIComponent('{"' + this._appId + '":{"defaultMode":"max"}}'));
            ...
            g.on(f, "click", function (a) {
                ...
                if (a = alloy.util.getActionTarget(a, 2, "cmd")) {
                    ...
                    if (alloy.portal.getLoginLevel() <
                        2 && b != "detail" && b != "home") alloy.layout.alert("\u60a8\u5c1a\u672a\u767b\u5f55QQ\uff0c\u8bf7\u767b\u5f55\u540e\u518d\u8fdb\u884c\u8be5\u64cd\u4f5c\u3002", function () {
        ...
        adjustButtons: function () {
            ...
            if (c < this._snsButtonNum * 78 + this._navButtonNum * 60) {
                ...
                this._sharebox && d.setStyle(this._sharebox.getElement(),
                    "right", "0px");
                ...
                c < (this._snsButtonNum + this._navButtonNum) * 35 ? (d.hide(this.backwardBtn.parentNode), d.hide(this.forwardBtn.parentNode),
                    d.hide(this.refreshBtn.parentNode), d.hide(a[2]), d.hide(a[3]), this._sharePanel && d.setStyle(this._sharePanel.container, "right", "40px")) : (this._buttonParams.hasBackwardButton && d.show(this.backwardBtn.parentNode), this._buttonParams.hasForwardButton && d.show(this.forwardBtn.parentNode), this._buttonParams.hasRefreshButton && d.show(this.refreshBtn.parentNode), d.show(a[2]), d.show(a[3]), this._sharePanel && d.setStyle(this._sharePanel.container, "right", "100px"), c < 255 && (this._commentPanel && this._commentPanel.isShow() &&
                    (this.panelManager.hidePanel("comment"), this.window.setNotCurrent(), d.removeClass(this.currentToolbarBtn, "app_toolbar_button_hover")), this._complainPanel && this._complainPanel.isShow() && (this.panelManager.hidePanel("complain"), this.window.setNotCurrent(), d.removeClass(this.currentToolbarBtn, "app_toolbar_button_hover")), this._sharebox && (this._sharePanel.isShow() || d.removeClass(this.currentToolbarBtn, "app_toolbar_button_hover"), this.panelManager.hidePanel("share2weibo"), this.window.setNotCurrent()),
                ...
                c > 480 ? (this._sharebox && d.setStyle(this._sharebox.getElement(), "right", "230px"), this._shareQzone && d.setStyle(this._shareQzone.getElement(), "right", "230px"), this._shareXiaoyou &&
                    d.setStyle(this._shareXiaoyou.getElement(), "right", "230px")) : (this._sharebox && d.setStyle(this._sharebox.getElement(), "right", "190px"), this._shareQzone && d.setStyle(this._shareQzone.getElement(), "right", "190px"), this._shareXiaoyou && d.setStyle(this._shareXiaoyou.getElement(), "right", "190px"))
            }
        },
        ...
        toggleScorePanel: function () {
            ...
            if (!this._scorePanel) {
                var c = '<div class="app_toolbar_scroebar"><div class="app_toolbar_scroe_outer"><span id="app_toolbar_scroe_' + this._appId + '" class="app_toolbar_scroe">0</span> \u5206</div><div class="app_toolbar_scroecount_outer"  id="app_toolbar_scroecount_' +
                    this._appId + '">0\u4eba</div></div><div class="app_toolbar_stars"><div id="app_toolbar_star_' + this._appId + '" class="app_toolbar_star"><span class="app_toolbar_star_btn" star="1" title="1\u5206"></span><span class="app_toolbar_star_btn" star="2" title="2\u5206"></span><span class="app_toolbar_star_btn" star="3" title="3\u5206"></span><span class="app_toolbar_star_btn" star="4" title="4\u5206"></span><span class="app_toolbar_star_btn" star="5" title="5\u5206"></span></div></div><div id="app_toolbar_scroebar_tip_' +
                    this._appId + '" class="app_toolbar_scroebar_tip">\u70b9\u51fb\u8bc4\u5206<sup>\u2191</sup></div>',
                    e = d.node("div", {
        ...
        toggleSharePanel: function () {
            var a = this,
                b = this.window.getToolBar();
            if (!this._sharePanel) {
                var c = '                \t<a class="app_toolbar_shareitem" id="app_toolbar_weibo_' +
                    this._appId + '" href="###">                \t\t<span class="app_toolbar_shareicon app_toolbar_weibo"></span>                \t\t<span>\u5fae\u535a</span>                \t</a>                \t<a class="app_toolbar_shareitem" id="app_toolbar_qzone_' + this._appId + '" href="###">                \t\t<span class="app_toolbar_shareicon app_toolbar_qzone"></span>                \t\t<span>\u7a7a\u95f4</span>                \t</a>                \t<a class="app_toolbar_shareitem" id="app_toolbar_qqfreinds_' +
                    this._appId + '" href="###">                \t\t<span class="app_toolbar_shareicon app_toolbar_qqfreinds"></span>                \t\t<span>\u597d\u53cb</span>                \t</a>                \t<iframe class="ui_maskBgIframe" src="domain.html" border="0"></iframe>                \t<a class="app_toolbar_shareitem" id="app_toolbar_xiaoyou_' + this._appId + '" href="###">                \t\t<span class="app_toolbar_shareicon app_toolbar_xiaoyou"></span>                \t\t<span>\u670b\u53cb</span>                \t</a>                \t',
                ...
                var c = this._sharePanel = new f.ui.Panel({
                    ...
                    p = {
                        ...
                        onQzoneItemClick: function (c) {
                            ...
                            g.addObserver(a._shareQzone,
                                "clickCloseButton", p.onShare2QzoneClose);
                        ...
                        onCloseShareQzone: function () {
                            if (a.currentToolbarBtn) d.removeClass(a.currentToolbarBtn,
                                "app_toolbar_button_hover"), a.currentToolbarBtn = null
                        },
                            ...
                            alloy.rpcService.cgiSend(alloy.CONST.JAVA_CGI_URL +
                                "cgi/qqweb/pengyou/share.do", {
                                    ...
                                    onSuccess: function (b) {
                                        ...
                                        }), a._shareXiaoyou.setHint(b), h("\u672a\u5f00\u901a\u670b\u53cb",
                                            "error", a.window)) : b.retcode != 0 ? h("\u5206\u4eab\u5931\u8d25", "error", a.window) : (h("\u5206\u4eab\u6210\u529f", "success", a.window), a._shareXiaoyou.hide(), a.reportAppShare(4))
                                    },
                                    onError: function () {}
                                });
                ...
                g.on(d.id("app_toolbar_qzone_" +
                    this._appId), "click", p.onQzoneItemClick);
    ...
    this.WidgetToolBar = new f.Class({
        init: function (a) {
            ...
            var d = f.ui.Button,
                e = a._titleButtonBar,
                g = "\u6211\u6b63\u5728\u4f7f\u7528Q+ Web\u4e2d\u7684#" +
                    (c.title || c.appName) + "#\u5e94\u7528\uff0c\u5f88\u4e0d\u9519\u54e6\uff0c\u63a8\u8350\u4f60\u4e5f\u6765\u73a9\uff01";
                    ...
                    onFriendClick: function (c) {
                        ...
                        if (b.invite) b.invite.show();
                            ...
                            var c = parseInt(a.getZIndex() || 100) + 1,
                                d = alloy.CONST.MAIN_URL + "?run=" + encodeURIComponent(encodeURIComponent('{"' +
                                    b._appId + '":{"defaultMode":"max"}}'));
    ...
    this.TitleToolBar = function (a) {
            ...
            H = function () {
                ...
                if (!F) {
                    ...
                    g.on(e, "mouseout", function (a) {
                        a.target == a.currentTarget && (x.myVote ? l(x.myVote) :
                            l(0))
                    });
                    g.on(e, "mousedown", n);
        ...
        this.setButton = function (a) {
            ...
            a.hasRefreshButton ? this.refreshButton.show() :
        ...
        g = {
            onMessage: function (b) {
                if (b.mt == 1) {
                    ...
                    2) c = b.appid, alloy.qplus.onWebMessage({
                    appId: c,
                    msg: b.m,
                    time: ""
                });
...
Jx().$package("alloy.messageSystem", function (f) {
    ...
    this.getMessageById = function (b) {
        for (var a = null, d = 0, e = g.length; d < e; d++)
            if (g[d].id == b) {
                a = g[d];
                break
            }
...
Jx().$package("alloy.notifier", function (f) {
    ...
    var b = this.ENABLE_FLAGS = {
        ...
        j = {}, k = {}, h = {
            onMessageReceive: function (b) {
                ...
                if (c = j[b.type])
                    for (var l in c)
                        if (d = c[l], e = a[d], h = k[d], b.type === "PushMessage" && (g = alloy.config.getMergedNotifications(b.body.appId)), !e.flag || e.flag & g)
                            if (e = h.context || window, h.onMessage) try {
            ...
            onMessageHandled: function (a) {
                ...
                if (b =
                    j[a.type])
                    for (var g in b)
                        if (c = b[g], d = k[c], e = d.context || window, d.onHandled) try {
    ...
    this.unregister = function (b) {
        var c, d;
        c = a[b];
        if (!c) throw Error("unregisterNotifier: no such config for " +
            b);
        if (!k[b]) return !1;
        k[b] = null;
        delete k[b];
            ...
            observer: {
                onMessageReceive: function (a) {
                    if (this.checkIsNeedNotify(a)) {
                        ...
                        case "SingleChat":
                            c =
                                alloy.util.getUserAvatar(b.uin, 1);
                            break;
                        case "GroupChat":
        ...
        r = new f.Class({
            ...
            observer: {
                ...
                onMessageHandled: function () {
                    this._totalMsgCount--;
                    if (this._totalMsgCount < 0) this._totalMsgCount =
                        0;
...
Jx().$package("alloy.apiManager", function (f) {
        ...
        v = function () {
            ...
            if (h)
                if (z.powerLevel >= h) {
                    ...
                    try {
                        if (k == "app")
                            if (p = alloy.system.getApp(l), g.addObserver(p, j, h), c[l][b.seq] = [p, j, h], j == "pushParam") {
            ...
            if (d && h.powerLevel >= d) try {
                var j;
                if (j =
                    (c[e] || 0)[b.seq]) g.removeObserver(j[0], j[1], j[2]), delete c[e][b.seq]
            } catch (k) {
    ...
    this.postMessage = function (b, c) {
        ...
        if (!f.isUndefined(b) && !f.isUndefined(b.wid) && !f.isUndefined(b.host) && !f.isUndefined(c)) {
            ...
            if (h && k.test(e))
                if (f.isUndefined(window.postMessage))
                    if (j) e = eval(e), a.PostMessageEx(h, e);
                    else {
                        if (!f.isUndefined(b.proxy))
                            if (k = function () {
                                var a = ["target=" + encodeURIComponent(e), "host=" +
    ...
    var H = {
        ...
        "system.shareApp": [{
            ...
            if (d = c[a]) {
                ...
                d = d[1];
                if (!c) return d(a, b), !0;
                for (var e in b.param)
                    if (b.param.hasOwnProperty(e) &&
                        c.hasOwnProperty(e)) return d(a, b), !0
            }
            return !1
        }, B = {
            ready: function (a) {
    ...
    g.addObserver(alloy, A.MSGNAME, function (a) {
        ...
        if (a.key && a.type && a.cmd && a.host && alloy.app.appKeyMap) {
            ...
            a.type == "method" ? (f.info("callMethod", "postMessage"), I(a.cmd, b, F) || I(a.cmd, b, H) || q(a.cmd, b)) : a.type == "event" ? a.cmd == "addEventListener" ? p(a.event, b) : a.cmd == "removeEventListener" && s(a.event, b) :
                a.type == "bind" ? p(a.cmd, b) : a.type == "unbind" ? s(a.cmd, b) : a.type == "message" && B[a.cmd] && B[a.cmd](b)
        }
    })
});
        ...
        onMessageReceive: function (a) {
            ...
            if (b) {
                ...
                case "SingleChat":
                    b.icon = "single";
                    b.avatar =
                        '<img class="avatar" src="' + alloy.util.getUserAvatar(a.body.uin) + '" alt="">';
...
Jx().$package(alloy.app.messageManager = new alloy.businessClass.App(alloy.portal.getSystemConfig("messageManager")), function (f) {
    var e = f.dom,
        ...
        m, n, l = {
            ...
            if (b.type == "group" || b.type == "single")
                for (var c = 0; c < h.length; ++c) {
                    var d = h[c].message,
                        e = b.message;
                    if (d.type == e.type && d.body.uin == e.body.uin)
                        if (d.body.time > e.body.time) return;
                        else {
                            h.splice(c, 1);
                            break
                        }
            ...
            switch (a.type) {
            case "SingleChat":
                !f.isUndefined(a.body.extra) && a.body.extra.attachType == "file" ? b = null : (b.avatar = '<img src="' + alloy.util.getUserAvatar(a.body.uin) +
                    '" alt="">', b.type = a.body.type);
                break;
            case "GroupChat":
            ...
            j = h.msgUl;
            j.firstChild ?
                j.insertBefore(d, j.firstChild) : j.appendChild(d);
            e.hide(h.noMsgTip);
            e.show(j);
            ...
            a.msgAreaBtn.nextSibling.title =
                "\u5c55\u5f00";
            e.hide(a.msgArea)
        }, t = function (a) {
            ...
            if (!f.isUndefined(a))
                for (c = a.length - 1; c >= 0; --c) d = a[c], e = {
                    from: "",
                    to: "",
                    type: "SingleChat",
                    id: 1E5 + d.seq,
    ...
    d.addObserver(this, "run", function () {
        if (j) j = !1, alloy.notifier.register("messageManager", l.onMessageReceive), d.addObserver(alloy.messageSystem, "MessageSourceRemove",
            l.onRemoveSource), d.addObserver(alloy.portal, "reset", l.onUinChange);
        else {
            if (!m) {
    ...
    this.init = function () {
        if (!g) {
            ...
            case "localStorage":
                ...
                this.clear = function () {
                    for (var a =
                        b + ".", c = 0, d = localStorage.length; c < d; ++c) {
...
Jx().$package("alloy.qplus", function (f) {
    var e = f.event,
        ...
        j = {}, k, h, m = {
            ...
            sendMarkShare: function (a) {
                ...
                alloy.rpcService.cgiSend(alloy.CONST.JAVA_CGI_URL + "cgi/top/mark_share", {
                    ...
                    data: a,
                    onSuccess: function (a) {
                        a.retcode == 0 ? f.profile("\u6807\u8bb0\u5206\u4eab\u5df2\u8bfb\u6210\u529f") :
                            f.profile("\u6807\u8bb0\u5206\u4eab\u5df2\u8bfb\u5931\u8d25")
                    },
                    onError: function () {
                        f.profile("\u6807\u8bb0\u5206\u4eab\u5df2\u8bfb\u5931\u8d25")
            ...
            sendShare: function (a) {
                ...
                alloy.rpcService.cgiSend(alloy.CONST.JAVA_CGI_URL + "cgi/top/send_share", {
                    ...
                    data: a,
                    onSuccess: function (a) {
                        a.retcode == 0 ? (e.show("\u5206\u4eab\u6210\u529f",
                            "success"), b && b()) : (e.show("\u5206\u4eab\u5931\u8d25", "error"), c && c())
                    },
                    onError: function () {
                        e.show("\u5206\u4eab\u5931\u8d25", "error");
                        c && c()
        ...
        v = function (c) {
            for (var d = c.appId, e, f = -1, g = 0; e = b[g]; g++)
                if (e.appId == d) {
                    f = g;
                    break
                }
            ...
            if ("number" in c) {
                ...
                for (var d = e.ext || [], h = e.count || 0, g = 0, j; j = d[g]; g++)
                    if (j.text == c.msg) return m.NONE;
                d.unshift({
                    text: c.msg,
                    time: c.time
                });
