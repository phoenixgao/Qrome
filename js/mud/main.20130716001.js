Jx().$package(alloy.app["app" + alloy.config.__eqqid] = alloy.app.eqq = new alloy.businessClass.App(alloy.portal.getAllConfig(alloy.config.__eqqid)), function (a) {
    var b = a.dom,
        ...
        i, k, n, h, o, m, d, v = function () {
            ...
            if (!d) {
                ...
                c.addObserver(alloy.portal, "selfInfoReady",
                    g.onSelfInfoReady);
    ...
    this.onNoneWindowResize = function () {
        var a = b.id("loginArea"),
            f = b.id("loginLoadingArea");
        a && f && (b.setStyle(a, "height", parseInt(b.getStyle(d.body, "height")) - 2 + "px"), b.setStyle(f, "height", parseInt(b.getStyle(d.body,
            "height")) - 2 + "px"))
    };
    var g = {
        ...
        onDragStart: function () {
            m = d.getBodySize();
            c.removeObserver(alloy.layout, "desktopResize",
                e.onWindowResize)
        },
        onDragEnd: function () {
            var a = d.getBodySize();
...
WebqCore = {
    ...
    load: function (a) {
        ...
        if (b)
            for (var c = 0; c < b.length; c++) Jx().$package(a, b[c])
    },
    ...
    init: function () {
        ...
        if (typeof EQQ != "undefined")
            for (var a in EQQ) EQQ.hasOwnProperty(a) && delete EQQ[a];
        EQQ = {};
        var b, c;
...
WebqCore.api = {
    ...
    require: {
        chat: [!1, "eqq.chat.js", "unlock",
            ...
            function () {
                ...
                alloy.portal.speedTest.sRTS(12, "end",
                    new Date, !0)
            }
        ],
    ...
    loadJs: function (a) {
        var b = this;
        b.require[a][3]();
        b.require[a][2] == "unlock" && (b.require[a][2] = "lock", b.loadedJsArr[b.require[a][1]] ? (b.require[a][0] = !0, b.require[a][4]()) :
            (Jx().http.loadScript(alloy.util.getAppRoot(alloy.config.__eqqid) + b.require[a][1] + "?t=" + alloy.CONST.UPDATE_TIME_STAMP, {
                query: "",
                onSuccess: function () {
    ...
    __api: {
        ...
        getChatBox: function (a) {
            return typeof EQQ.Presenter.ChatBox !=
                "undefined" && typeof EQQ.Presenter.ChatBox.View != "undefined" ? EQQ.Presenter.ChatBox.getChatBox(a) : !1
        },
